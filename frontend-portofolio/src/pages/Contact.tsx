    ...
    return (
        <section id="contact" className="py-20 relative z-10">
            <div className="max-w-3xl mx-auto px-4 md:px-0">
                ...
                >
                    <div className="glass-heavy p-8 md:p-12 rounded-3xl border border-white/5 relative overflow-hidden group">
                        <div className="absolute inset-0 bg-gradient-to-tr from-primary-500/5 to-secondary-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none" />
